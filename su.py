...
if selected == 'Heart Disease Prediction':
    ...
    if st.button('Heart Disease Test Result'):
        try:
            # Convert inputs to numeric values explicitly
            inputs = [
            ...
            # Predict using the loaded model (replace `heart_disease_model` with your actual model)
